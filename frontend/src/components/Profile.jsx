    ...
    return (
        <div className="bg-[#1A1A1A] min-h-screen flex flex-col justify-between">
            ...
            <div className="flex-grow px-4">
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-2xl my-5 p-6 sm:p-8 shadow-md transition-transform duration-300 hover:scale-105">
                    <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-6">
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
                            ...
                            <div className="text-center sm:text-left">
                                <h1 className="font-medium text-xl text-white" style={{ fontFamily: 'Google Sans, sans-serif' }}>
                                    {user?.fullname}
                                </h1>
                                <p className="text-gray-300" style={{ fontFamily: 'Google Sans, sans-serif' }}>
                                    {user?.profile?.bio}
                                </p>
                            </div>
                        </div>
                        <div className="flex justify-center sm:justify-end">
                            <Button onClick={() => setOpen(true)} className="bg-gray-700 text-white hover:bg-gray-600" variant="outline">
                                <Pen />
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="my-5">
                        <h1 className="text-white mb-2" style={{ fontFamily: 'Google Sans, sans-serif' }}>Skills</h1>
                ...
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-2xl pb-10 shadow-md my-5">
                    <h1 className="font-bold text-lg my-5 text-white text-center" style={{ fontFamily: 'Google Sans, sans-serif' }}>
                        Applied Jobs
                    </h1>
                    <AppliedJobTable className="text-white" />
                </div>
